...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/sultan-wiratama-116871392",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@wira_tama_sultan",
    icon: Instagram,
    url: "https://www.instagram.com/wira_tama_sultan",
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@wiratamasultan65-max",
    icon: Github,
    url: "https://github.com/wiratamasultan65-max",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://tiktok.com/@wiraaa_987",
    color: "black",
